...
@WebServlet(name = "MemberShowServlet", value = "/MemberShowServlet")
public class MemberShowServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            // 查询总记录数
            String countSql = "SELECT COUNT(*) AS total FROM members";
            ...
            // 处理查询结果
            List<MemberAdd> pageCashiers = new ArrayList<>();
            while (rs.next()) {
                ...
                MemberAdd member = new MemberAdd(id, name, sex, age);
                pageCashiers.add(member);
            }
            ...
            // 构建异常情况下的响应
            MemberShowServlet.ErrorResult errorResult = new MemberShowServlet.ErrorResult("An error occurred while processing the request.");
            Gson gson = new Gson();
